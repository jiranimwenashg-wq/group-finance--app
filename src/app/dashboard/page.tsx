...
async function OverviewChartData() {
    const overview = await getFinancialOverview();
    return <OverviewChart data={overview.chartData} />;
}
  ...
  return (
    <div className="flex flex-col gap-4">
        <div className="space-y-1">
            ...
            <p className="text-muted-foreground">A snapshot of your group's financial health.</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-7">
        <Suspense fallback={<Skeleton className="lg:col-span-3 h-[400px]" />}>
            <OverviewChartData />
        </Suspense>
